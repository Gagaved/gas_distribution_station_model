                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Builder(builder: (context) {
                        void save() {
                          try {
                            final value = universalGasConstantController.text;
                            final formatedString =
                                value.replaceAllMapped(',', (f) => '.');
                      ...
                      child: Builder(builder: (context) {
                        void save() {
                          try {
                            ...
                            final formatedString =
                                value.replaceAllMapped(',', (f) => '.');
                            stateStore.molarMass = double.parse(formatedString);
                            print('set molarMass to ${stateStore.molarMass}');
                      ...
                      child: Builder(builder: (context) {
                        void save() {
                          try {
                            ...
                            final formatedString =
                                value.replaceAllMapped(',', (f) => '.');
                            stateStore.zFactor = double.parse(formatedString);
                    ...
                    MaterialButton(
                      onPressed:
                          stateStore.calculateStatus != CalculateStatus.process
                              ? () {
